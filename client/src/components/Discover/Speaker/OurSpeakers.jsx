  ...
  return (
    <section className="relative h-screen overflow-visible mt-0 sm:mt-20">
      ...
      <div className="container mx-auto px-4 text-center h-full flex flex-col justify-center md:mt-14 relative z-20">
        ...
        >
          Our events bring together thinkers, innovators, and storytellers who challenge perspectives and inspire action. Explore the diverse minds that have graced our stage.
        </motion.p>
      </div>
    </section>
  );
