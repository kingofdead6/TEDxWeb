...
function UserTable() {
  ...
  // Filter users by search term (memoized to avoid unnecessary re-renders)
  useEffect(() => {
    ...
    <div className="min-h-screen p-4 sm:p-6">
      ...
      >
        ...
        <div className="p-6 sm:p-8">
          {loading && (
            <motion.div
              className="mb-6 p-4 bg-blue-50 text-blue-900 rounded-lg border border-blue-200 text-sm sm:text-base"
          ...
          >
            ...
            >
              <h3
                ...
                className="text-xl sm:text-2xl font-semibold text-[#d20000] mb-4 text-center"
              >
                Confirm Deletion
              </h3>
              <p
